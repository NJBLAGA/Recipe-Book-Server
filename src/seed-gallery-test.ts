...
const PANTRY_SEED: Array<{
  name: string; category: string; stockStatus: 'in_stock' | 'low_stock' | 'out_of_stock';
  quantity: number | null; unit: string | null; notes: string | null; images: string[];
}> = [
  // Dairy & Eggs (17 items)
  { name: 'Eggs', category: 'Dairy & Eggs', stockStatus: 'in_stock', quantity: 12, unit: 'pack', notes: 'Free range, size 7',
  ...
  { name: 'Milk', category: 'Dairy & Eggs', stockStatus: 'in_stock', quantity: 2, unit: 'L', notes: 'Full cream',
  ...
  { name: 'Butter', category: 'Dairy & Eggs', stockStatus: 'out_of_stock', quantity: 1, unit: 'block', notes: null,
  ...
  { name: 'Cheddar Cheese', category: 'Dairy & Eggs', stockStatus: 'in_stock', quantity: 400, unit: 'g', notes: 'Vintage cheddar',
  ...
  { name: 'Greek Yoghurt', category: 'Dairy & Eggs', stockStatus: 'in_stock', quantity: 500, unit: 'g', notes: 'Full fat',
  ...
  { name: 'Sour Cream', category: 'Dairy & Eggs', stockStatus: 'out_of_stock', quantity: null, unit: null, notes: 'Need to restock',
  ...
  { name: 'Parmesan', category: 'Dairy & Eggs', stockStatus: 'in_stock', quantity: 200, unit: 'g', notes: 'Freshly grated',
  ...
  { name: 'Cream', category: 'Dairy & Eggs', stockStatus: 'in_stock', quantity: 300, unit: 'ml', notes: 'Thickened cream',
  ...
  { name: 'Ricotta', category: 'Dairy & Eggs', stockStatus: 'in_stock', quantity: 500, unit: 'g', notes: 'Fresh from deli',
  ...
  { name: 'Mozzarella', category: 'Dairy & Eggs', stockStatus: 'in_stock', quantity: 200, unit: 'g', notes: 'Buffalo, fresh',
  ...
  { name: 'Cream Cheese', category: 'Dairy & Eggs', stockStatus: 'out_of_stock', quantity: 250, unit: 'g', notes: null,
    images: ['https://images.unsplash.com/photo-1603048588665-791ca8aea617?w=600&q=80'] },
  { name: 'Feta Cheese', category: 'Dairy & Eggs', stockStatus: 'in_stock', quantity: 200, unit: 'g', notes: 'Greek, in brine',
  ...
  { name: 'Kefir', category: 'Dairy & Eggs', stockStatus: 'out_of_stock', quantity: 1, unit: 'bottle', notes: 'Plain, probiotic',
    images: ['https://images.unsplash.com/photo-1571212515416-fca7b2e61b12?w=600&q=80'] },
  { name: 'Cottage Cheese', category: 'Dairy & Eggs', stockStatus: 'in_stock', quantity: 250, unit: 'g', notes: null,
  ...
  { name: 'Brie', category: 'Dairy & Eggs', stockStatus: 'in_stock', quantity: 125, unit: 'g', notes: 'Ripe, perfect for board',
  ...
  { name: 'Double Cream', category: 'Dairy & Eggs', stockStatus: 'out_of_stock', quantity: 200, unit: 'ml', notes: 'For desserts', images: [] },
  { name: 'Oat Milk', category: 'Dairy & Eggs', stockStatus: 'in_stock', quantity: 1, unit: 'L', notes: 'Barista blend',
  ...
  // Fruit & Veg (15 items)
  { name: 'Bananas', category: 'Fruit & Veg', stockStatus: 'in_stock', quantity: 6, unit: null, notes: 'Cavendish, starting to ripen',
  ...
  { name: 'Spinach', category: 'Fruit & Veg', stockStatus: 'in_stock', quantity: 1, unit: 'bag', notes: 'Baby leaf',
  ...
  { name: 'Cherry Tomatoes', category: 'Fruit & Veg', stockStatus: 'in_stock', quantity: 1, unit: 'punnet', notes: null,
  ...
  { name: 'Avocados', category: 'Fruit & Veg', stockStatus: 'out_of_stock', quantity: null, unit: null, notes: 'Out — buy ripe ones',
  ...
  { name: 'Garlic', category: 'Fruit & Veg', stockStatus: 'in_stock', quantity: 3, unit: 'bulbs', notes: null,
  ...
  { name: 'Brown Onions', category: 'Fruit & Veg', stockStatus: 'in_stock', quantity: 5, unit: null, notes: null,
  ...
  { name: 'Lemons', category: 'Fruit & Veg', stockStatus: 'in_stock', quantity: 4, unit: null, notes: null,
  ...
  { name: 'Sweet Potato', category: 'Fruit & Veg', stockStatus: 'out_of_stock', quantity: null, unit: null, notes: null,
  ...
  { name: 'Zucchini', category: 'Fruit & Veg', stockStatus: 'in_stock', quantity: 3, unit: null, notes: null,
  ...
  { name: 'Red Capsicum', category: 'Fruit & Veg', stockStatus: 'in_stock', quantity: 2, unit: null, notes: null,
  ...
  { name: 'Broccoli', category: 'Fruit & Veg', stockStatus: 'in_stock', quantity: 1, unit: 'head', notes: null,
  ...
  { name: 'Mushrooms', category: 'Fruit & Veg', stockStatus: 'out_of_stock', quantity: 200, unit: 'g', notes: 'Swiss brown',
  ...
  { name: 'Cucumber', category: 'Fruit & Veg', stockStatus: 'in_stock', quantity: 2, unit: null, notes: 'Continental',
  ...
  { name: 'Kale', category: 'Fruit & Veg', stockStatus: 'out_of_stock', quantity: 1, unit: 'bunch', notes: 'Tuscan / Cavolo nero',
  ...
  { name: 'Strawberries', category: 'Fruit & Veg', stockStatus: 'in_stock', quantity: 1, unit: 'punnet', notes: 'In season',
  ...
  { name: 'Chicken Breast', category: 'Meat & Seafood', stockStatus: 'in_stock', quantity: 500, unit: 'g', notes: 'Free range, skin off',
  ...
  { name: 'Salmon Fillets', category: 'Meat & Seafood', stockStatus: 'in_stock', quantity: 2, unit: 'fillets', notes: 'Atlantic, skin on',
  ...
  { name: 'Beef Mince', category: 'Meat & Seafood', stockStatus: 'out_of_stock', quantity: null, unit: null, notes: 'Buy 500g lean',
  ...
  { name: 'Chicken Thighs', category: 'Meat & Seafood', stockStatus: 'in_stock', quantity: 1, unit: 'kg', notes: 'Bone-in',
  ...
  { name: 'Prawns', category: 'Meat & Seafood', stockStatus: 'out_of_stock', quantity: null, unit: null, notes: 'Buy fresh from market',
  ...
  { name: 'Lamb Cutlets', category: 'Meat & Seafood', stockStatus: 'in_stock', quantity: 4, unit: 'cutlets', notes: 'French trimmed',
  ...
  { name: 'Bacon', category: 'Meat & Seafood', stockStatus: 'in_stock', quantity: 1, unit: 'pack', notes: 'Middle rashers',
  ...
  { name: 'Pork Belly', category: 'Meat & Seafood', stockStatus: 'in_stock', quantity: 500, unit: 'g', notes: 'Skin on, scored',
  ...
  { name: 'Tuna Steaks', category: 'Meat & Seafood', stockStatus: 'out_of_stock', quantity: 2, unit: 'steaks', notes: null,
    images: ['https://images.unsplash.com/photo-1467003909585-2f8a72700288?w=600&q=80'] },
  { name: 'Chorizo', category: 'Meat & Seafood', stockStatus: 'in_stock', quantity: 1, unit: 'pack', notes: 'Hot variety, sliced',
  ...
  { name: 'Turkey Breast', category: 'Meat & Seafood', stockStatus: 'out_of_stock', quantity: 500, unit: 'g', notes: 'Sliced, deli style',
  ...
  { name: 'Duck Breast', category: 'Meat & Seafood', stockStatus: 'in_stock', quantity: 2, unit: 'breasts', notes: 'Skin on, score and render',
  ...
  { name: 'Squid', category: 'Meat & Seafood', stockStatus: 'out_of_stock', quantity: 300, unit: 'g', notes: 'Cleaned tubes and rings', images: [] },
  { name: 'Mussels', category: 'Meat & Seafood', stockStatus: 'in_stock', quantity: 500, unit: 'g', notes: 'Fresh, cleaned',
  ...
  { name: 'Snapper', category: 'Meat & Seafood', stockStatus: 'in_stock', quantity: 1, unit: 'whole', notes: 'Ask fishmonger to scale',
  ...
  { name: 'Pork Mince', category: 'Meat & Seafood', stockStatus: 'out_of_stock', quantity: 500, unit: 'g', notes: null, images: [] },

  // Pantry Staples (10 items)
  { name: 'Olive Oil', category: 'Pantry Staples', stockStatus: 'in_stock', quantity: 1, unit: 'bottle', notes: 'Extra virgin, cold pressed',
    images: ['https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?w=600&q=80'] },
  { name: 'Flour', category: 'Pantry Staples', stockStatus: 'in_stock', quantity: 1, unit: 'kg', notes: 'Plain flour',
  ...
  { name: 'Sugar', category: 'Pantry Staples', stockStatus: 'out_of_stock', quantity: null, unit: null, notes: 'Ran out — buy white caster', images: [] },
  { name: 'Salt', category: 'Pantry Staples', stockStatus: 'in_stock', quantity: 1, unit: 'box', notes: 'Murray River pink salt',
    images: ['https://images.unsplash.com/photo-1533038590840-1cde6e668a91?w=600&q=80'] },
  { name: 'Black Pepper', category: 'Pantry Staples', stockStatus: 'in_stock', quantity: 1, unit: 'grinder', notes: null, images: [] },
  { name: 'Soy Sauce', category: 'Pantry Staples', stockStatus: 'in_stock', quantity: 1, unit: 'bottle', notes: 'Kikkoman',
    images: ['https://images.unsplash.com/photo-1580822184713-fc5400e7fe10?w=600&q=80'] },
  { name: 'Honey', category: 'Pantry Staples', stockStatus: 'in_stock', quantity: 500, unit: 'g', notes: 'Raw manuka',
    images: ['https://images.unsplash.com/photo-1587049352846-4a222e784d38?w=600&q=80'] },
  { name: 'Tinned Tomatoes', category: 'Pantry Staples', stockStatus: 'in_stock', quantity: 3, unit: 'cans', notes: '400g each',
    images: ['https://images.unsplash.com/photo-1548247416-ec66f4900b2e?w=600&q=80'] },
  { name: 'Coconut Milk', category: 'Pantry Staples', stockStatus: 'out_of_stock', quantity: null, unit: null, notes: null, images: [] },
  { name: 'Chicken Stock', category: 'Pantry Staples', stockStatus: 'in_stock', quantity: 2, unit: 'cartons', notes: '1L each',
  ...
  for (const seed of PANTRY_SEED) {
    ...
    if (existingItem) {
      await db.update(pantryItem).set({
        stockStatus: seed.stockStatus, quantity: seed.quantity, unit: seed.unit,
      ...
      const [created] = await db.insert(pantryItem).values({
        pantryId, ingredientId, stockStatus: seed.stockStatus, quantity: seed.quantity,
