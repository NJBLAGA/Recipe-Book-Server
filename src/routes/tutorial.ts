...
router.post('/seed', async (req, res) => {
  ...
  const pantrySeeds: Array<{
    name: string; cat: string; stockStatus: 'in_stock' | 'low_stock' | 'out_of_stock';
    quantity?: number | null; unit?: string | null;
  }> = [
    { name: 'eggs', cat: 'Dairy & Eggs', stockStatus: 'in_stock', quantity: 12, unit: 'pack' },
    { name: 'butter', cat: 'Dairy & Eggs', stockStatus: 'low_stock', quantity: 1, unit: 'block' },
    { name: 'milk', cat: 'Dairy & Eggs', stockStatus: 'in_stock', quantity: 2, unit: 'litre' },
    { name: 'parmesan', cat: 'Dairy & Eggs', stockStatus: 'low_stock' },
    ...
    { name: 'mixed mushrooms', cat: 'Vegetables', stockStatus: 'in_stock' },
    { name: 'cherry tomatoes', cat: 'Vegetables', stockStatus: 'low_stock' },
    ...
    { name: 'ground cumin', cat: 'Herbs & Spices', stockStatus: 'low_stock' },
