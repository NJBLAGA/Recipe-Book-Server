...
async function main() {
  ...
  if (pantryRow && Object.keys(pantryCatMap).length > 0) {
    const pantrySeeds: Array<{ name: string; cat: string; stockStatus: 'in_stock' | 'low_stock' | 'out_of_stock'; quantity?: number; unit?: string }> = [
      { name: 'eggs', cat: 'Dairy & Eggs', stockStatus: 'in_stock', quantity: 12, unit: 'pack' },
      { name: 'butter', cat: 'Dairy & Eggs', stockStatus: 'in_stock', quantity: 2, unit: 'block' },
      { name: 'milk', cat: 'Dairy & Eggs', stockStatus: 'in_stock', quantity: 2, unit: 'litre' },
      { name: 'parmesan', cat: 'Dairy & Eggs', stockStatus: 'in_stock' },
      { name: 'heavy cream', cat: 'Dairy & Eggs', stockStatus: 'out_of_stock' },
      { name: 'chicken thighs', cat: 'Meat & Fish', stockStatus: 'in_stock', quantity: 1, unit: 'pack' },
      { name: 'minced beef', cat: 'Meat & Fish', stockStatus: 'out_of_stock' },
      { name: 'prawns', cat: 'Meat & Fish', stockStatus: 'in_stock', quantity: 1, unit: 'bag' },
      { name: 'garlic', cat: 'Vegetables', stockStatus: 'in_stock', quantity: 1, unit: 'bulb' },
      { name: 'onion', cat: 'Vegetables', stockStatus: 'in_stock', quantity: 1, unit: 'bag' },
      { name: 'carrot', cat: 'Vegetables', stockStatus: 'in_stock' },
      { name: 'celery', cat: 'Vegetables', stockStatus: 'out_of_stock' },
      { name: 'mushrooms', cat: 'Vegetables', stockStatus: 'in_stock' },
      { name: 'zucchini', cat: 'Vegetables', stockStatus: 'low_stock' },
      { name: 'cherry tomatoes', cat: 'Vegetables', stockStatus: 'in_stock' },
      { name: 'avocado', cat: 'Fruit', stockStatus: 'in_stock', quantity: 2, unit: 'loose' },
      { name: 'lemon', cat: 'Fruit', stockStatus: 'in_stock', quantity: 4, unit: 'loose' },
      { name: 'ripe bananas', cat: 'Fruit', stockStatus: 'low_stock', quantity: 1, unit: 'bunch' },
      { name: 'olive oil', cat: 'Pantry Staples', stockStatus: 'in_stock', quantity: 1, unit: 'bottle' },
      { name: 'plain flour', cat: 'Pantry Staples', stockStatus: 'in_stock', quantity: 1, unit: 'bag' },
      { name: 'canned chickpeas', cat: 'Pantry Staples', stockStatus: 'in_stock', quantity: 3, unit: 'can' },
      { name: 'crushed tomatoes', cat: 'Pantry Staples', stockStatus: 'in_stock', quantity: 4, unit: 'can' },
      { name: 'cannellini beans', cat: 'Pantry Staples', stockStatus: 'in_stock', quantity: 2, unit: 'can' },
      { name: 'tomato paste', cat: 'Pantry Staples', stockStatus: 'in_stock' },
      { name: 'spaghetti', cat: 'Pantry Staples', stockStatus: 'in_stock', quantity: 2, unit: 'pack' },
      { name: 'arborio rice', cat: 'Pantry Staples', stockStatus: 'out_of_stock' },
      { name: 'basmati rice', cat: 'Pantry Staples', stockStatus: 'in_stock', quantity: 1, unit: 'bag' },
      { name: 'dried oregano', cat: 'Herbs & Spices', stockStatus: 'in_stock' },
      { name: 'garam masala', cat: 'Herbs & Spices', stockStatus: 'in_stock' },
      { name: 'ground cumin', cat: 'Herbs & Spices', stockStatus: 'in_stock' },
      { name: 'turmeric', cat: 'Herbs & Spices', stockStatus: 'in_stock' },
      { name: 'chilli powder', cat: 'Herbs & Spices', stockStatus: 'in_stock' },
      { name: 'cinnamon', cat: 'Herbs & Spices', stockStatus: 'in_stock' },
      { name: 'sourdough bread', cat: 'Bakery', stockStatus: 'in_stock', quantity: 1, unit: 'loaf' },
      { name: 'baguette', cat: 'Bakery', stockStatus: 'out_of_stock' },
    ];
